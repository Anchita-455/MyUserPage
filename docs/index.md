...
1. #### **Richter's Predictor** #### 
    [Github Repo](https://github.com/Anchita-455/RichtersPredictor)
...
2. #### **Human Activity Recognition (HAR)** #### 
   [Github Repo](https://github.com/Anchita-455/HAR)
...
3. #### **Constellio** #### 
   [Github Repo](https://github.com/Anchita-455/schoolprojects/tree/main/java/Constellio)
...
- Developed a web-based application to visualize habitat and connectivity models of tree species in California across different climate scenarios  
